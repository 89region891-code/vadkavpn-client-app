...
class OpenVPNAdapter(ConanFile):
    ...
    def source(self):
        git = Git(self)
        git.clone(
            url="https://github.com/ВадькаVPN-vpn/OpenVPNAdapter.git",
            target=".",
            args=["--recurse-submodules", "--branch", "master-ВадькаVPN"]
        )
    ...
    def package_info(self):
        self.cpp_info.set_property("cmake_target_name", "ВадькаVPN::openvpnadapter")
