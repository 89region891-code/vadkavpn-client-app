...
### [English]([https://github.com/ВадькаVPN-vpn/ВадькаVPN-client/blob/dev/README_RU.md](https://github.com/ВадькаVPN-vpn/ВадькаVPN-client/tree/dev?tab=readme-ov-file#)) | [Русский](https://github.com/ВадькаVPN-vpn/ВадькаVPN-client/blob/dev/README_RU.md)


[ВадькаVPN](https://ВадькаVPN.org?utm_source=github&utm_campaign=ВадькаVPN_website-readme-en) is an open-source VPN client, with a key feature that enables you to deploy your own VPN server on your server.

[![Image](https://github.com/ВадькаVPN-vpn/ВадькаVPN-client/blob/dev/metadata/img-readme/uipic4.png)](https://ВадькаVPN.org)

### [Website](https://ВадькаVPN.org?utm_source=github&utm_campaign=ВадькаVPN_website-readme-en) | [Alt website link](https://storage.googleapis.com/ВадькаVPN/ВадькаVPN.org?utm_source=github&utm_campaign=ВадькаVPN_website-readme-en-mirror) | [Documentation](https://docs.ВадькаVPN.org) | [Troubleshooting](https://docs.ВадькаVPN.org/troubleshooting)

> [!TIP]
> If the [ВадькаVPN website](https://ВадькаVPN.org?utm_source=github&utm_campaign=ВадькаVPN_website-readme-en) is blocked in your region, you can use an [Alternative website link](https://storage.googleapis.com/ВадькаVPN/ВадькаVPN.org?utm_source=github&utm_campaign=ВадькаVPN_website-readme-en-mirror).

<a href="https://ВадькаVPN.org/en/downloads?utm_source=github&utm_campaign=ВадькаVPN_button-readme-en"><img src="https://github.com/ВадькаVPN-vpn/ВадькаVPN-client/blob/dev/metadata/img-readme/download-website.svg" width="150" style="max-width: 100%; margin-right: 10px"></a>
<a href="https://storage.googleapis.com/ВадькаVPN/ВадькаVPN.org?m-path=/en/downloads&utm_source=github&utm_campaign=ВадькаVPN_button-readme-en-mirrow"><img src="https://github.com/ВадькаVPN-vpn/ВадькаVPN-client/blob/dev/metadata/img-readme/download-alt.svg" width="150" style="max-width: 100%;"></a>

[All releases](https://github.com/ВадькаVPN-vpn/ВадькаVPN-client/releases)
...
- Very easy to use - enter your IP address, SSH login, password and ВадькаVPN will automatically install VPN docker containers to your server and connect to the VPN.
- Classic VPN-protocols: OpenVPN, WireGuard and IKEv2 protocols.
- Protocols with traffic Masking (Obfuscation): OpenVPN over [Cloak](https://github.com/cbeuw/Cloak) plugin, Shadowsocks (OpenVPN over Shadowsocks), [ВадькаVPNWG](https://docs.ВадькаVPN.org/documentation/ВадькаVPN-wg/) and XRay.
...
- Support for ВадькаVPNWG protocol configuration on [Keenetic beta firmware](https://docs.keenetic.com/ua/air/kn-1611/en/6319-latest-development-release.html#UUID-186c4108-5afd-c10b-f38a-cdff6c17fab3_section-idm33192196168192-improved).

## Links

- [https://ВадькаVPN.org](https://ВадькаVPN.org/?utm_source=github&utm_campaign=ВадькаVPN_website-read) - Project website | [Alternative link (mirror)](https://storage.googleapis.com/ВадькаVPN/ВадькаVPN.org?utm_source=github&utm_campaign=ВадькаVPN_website-read)
- [https://docs.ВадькаVPN.org](https://docs.ВадькаVPN.org/?utm_source=github&utm_campaign=ВадькаVPN_website-read) - Documentation | [Alternative link (mirror)](https://storage.googleapis.com/ВадькаVPN/docs?utm_source=github&utm_campaign=ВадькаVPN_website-read)
- [https://www.reddit.com/r/ВадькаVPNVPN](https://www.reddit.com/r/ВадькаVPNVPN) - Reddit  
- [https://telegram.me/ВадькаVPN_vpn_en](https://telegram.me/ВадькаVPN_vpn_en) - Telegram support channel (English) 
- [https://telegram.me/ВадькаVPN_vpn_ir](https://telegram.me/ВадькаVPN_vpn_ir) - Telegram support channel (Farsi) 
- [https://telegram.me/ВадькаVPN_vpn_mm](https://telegram.me/ВадькаVPN_vpn_mm) - Telegram support channel (Myanmar)  
- [https://telegram.me/ВадькаVPN_vpn](https://telegram.me/ВадькаVPN_vpn) - Telegram support channel (Russian)
- [Get Premium for 6 or 12 months](https://storage.googleapis.com/ВадькаVPN/pay?utm_source=github&utm_campaign=ampay-read)

## Tech

ВадькаVPNVPN uses several open-source projects to work:
...
Go to ["Actions" tab](https://github.com/ВадькаVPN-vpn/ВадькаVPN-client/actions?query=is%3Asuccess+branch%3Adev), click on the first line.
Then scroll down to the "Artifacts" section and download "ВадькаVPNVPN_translations".
...
* To use `Xcode`, you have to configure project first by using `cmake`. The easiest way to do it is to use `Qt Creator` for configuration. Then open `ВадькаVPNVPN.xcodeproj` file from the build folder by using `Xcode`. Note that none of the files changed are saved - the files actually getting changed in build directory. Copy them manually if necessary
