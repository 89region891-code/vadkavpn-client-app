...
if(APPLE)
    ...
    list(FILTER client_exec INCLUDE REGEX [[ВадькаVPNVPN$]])
    set(service_exec ${execs})
    list(FILTER service_exec INCLUDE REGEX [[ВадькаVPNVPN-service$]])
    set(other_execs ${execs})
    list(FILTER other_execs EXCLUDE REGEX [[ВадькаVPNVPN$|ВадькаVPNVPN-service$]])
