...
void NetworkWatcher::initialize() {
  ...
  m_active = true;
  m_reportUnsecuredNetwork = false; // Disable unsecured network alerts for ВадькаVPN
}

void NetworkWatcher::settingsChanged() {
  // For ВадькаVPN: Keep NetworkWatcher always active for sleep/wake monitoring
