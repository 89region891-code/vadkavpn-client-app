...
PageType {
    ...
    QtObject {
        ...
        readonly property string description: qsTr("ВадькаVPNVPN logs")
    ...
    QtObject {
        ...
        readonly property string description: qsTr("ВадькаVPNVPN-service logs")
        ...
        readonly property var exportLogsHandler: function() {
            ...
            fileName = SystemController.getFileName(qsTr("Save"),
                                                    qsTr("Logs files (*.log)"),
                                                    StandardPaths.standardLocations(StandardPaths.DocumentsLocation) + "/ВадькаVPNVPN-service",
                                                    true,
                                                    ".log")
            if (fileName !== "") {
                PageController.showBusyIndicator(true)
