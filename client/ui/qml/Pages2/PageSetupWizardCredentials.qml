    ...
    ListViewType {
        ...
        delegate: ColumnLayout {
            ...
            WarningType {
                ...
                backGroundColor: ВадькаVPNStyle.color.translucentWhite
        ...
        footer: ColumnLayout {
            ...
            LabelTextType {
                ...
                text: qsTr("All data you enter will remain strictly confidential and will not be shared or disclosed to the ВадькаVPN or any third parties")
            }
