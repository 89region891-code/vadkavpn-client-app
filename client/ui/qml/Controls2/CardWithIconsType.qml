...
Button {
    ...
    property color headerTextColor: ВадькаVPNStyle.color.paleGray
    property color bodyTextColor: ВадькаVPNStyle.color.mutedGray
    property bool showRecommendedBadge: false
    property string recommendedText: ""

    property string hoveredColor: ВадькаVPNStyle.color.slateGray
    property string defaultColor: ВадькаVPNStyle.color.onyxBlack
        ...
        ColumnLayout {
            ...
            Item {
                ...
                Rectangle {
                    ...
                    radius: 10
                    color: ВадькаVPNStyle.color.softViolet
