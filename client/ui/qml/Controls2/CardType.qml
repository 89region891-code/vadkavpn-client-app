...
RadioButton {
    ...
    property string selectedColor: ВадькаVPNStyle.color.transparent

    property string textColor: ВадькаVPNStyle.color.midnightBlack

    property string pressedBorderColor: ВадькаVPNStyle.color.softGoldenApricot
    property string selectedBorderColor: ВадькаVPNStyle.color.goldenApricot
    property string defaultBodredColor: ВадькаVPNStyle.color.transparent
    property string focusBorderColor: ВадькаVPNStyle.color.paleGray
