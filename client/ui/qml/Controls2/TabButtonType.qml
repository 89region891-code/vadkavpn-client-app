...
TabButton {
    ...
    property string hoveredColor: ВадькаVPNStyle.color.richBrown
    property string defaultColor: ВадькаVPNStyle.color.slateGray
    property string selectedColor: ВадькаVPNStyle.color.goldenApricot
