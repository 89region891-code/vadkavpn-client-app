...
Button {
    ...
    property string hoveredColor: ВадькаVPNStyle.color.lightGray
    property string defaultColor: ВадькаVPNStyle.color.paleGray
    property string disabledColor: ВадькаVPNStyle.color.charcoalGray
    property string pressedColor: ВадькаVPNStyle.color.mutedGray

    property string textColor: ВадькаVPNStyle.color.midnightBlack

    property string borderColor: ВадькаVPNStyle.color.paleGray
