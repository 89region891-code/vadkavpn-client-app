...
Rectangle {
    ...
    border.color: selected ? ВадькаVPNStyle.color.goldenApricot : ВадькаVPNStyle.color.charcoalGray
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            LabelTextType {
                ...
                color: root.selected ? ВадькаVPNStyle.color.goldenApricot : ВадькаVPNStyle.color.paleGray
                font.pixelSize: 17
