...
Button {
    ...
    property string defaultButtonColor: ВадькаVPNStyle.color.paleGray
    property string progressButtonColor: ВадькаVPNStyle.color.paleGray
    property string connectedButtonColor: ВадькаVPNStyle.color.goldenApricot
    ...
    background: Item {
        ...
        Shape {
            ...
            layer.effect: DropShadow {
                ...
                radius: 10
                samples: 25
                color: root.buttonActiveFocus ? ВадькаVPNStyle.color.paleGray : ВадькаVPNStyle.color.goldenApricot
                source: backgroundCircle
            }

            ShapePath {
                fillColor: ВадькаVPNStyle.color.transparent
                strokeColor: ВадькаVPNStyle.color.paleGray
            ...
            ShapePath {
                ...
                strokeColor: {
                    if (ConnectionController.isConnectionInProgress) {
                        return ВадькаVPNStyle.color.darkCharcoal
