...
public slots:
    void updateModel(const QMap<ВадькаVPN::DockerContainer, ВадькаVPN::ContainerConfig> &containers);
    ...
    static bool isInstallationAllowed(ВадькаVPN::DockerContainer container);
...
private:
    QMap<ВадькаVPN::DockerContainer, ВадькаVPN::ContainerConfig> m_containers;
