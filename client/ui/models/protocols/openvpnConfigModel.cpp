...
bool OpenVpnConfigModel::setData(const QModelIndex &index, const QVariant &value, int role)
{
    ...
    case Roles::BlockDnsRole: {
        if (!m_protocolConfig.clientConfig.has_value()) {
            m_protocolConfig.clientConfig = ВадькаVPN::OpenVpnClientConfig{};
        }
...
void OpenVpnConfigModel::updateModel(ВадькаVPN::DockerContainer container, const ВадькаVPN::OpenVpnProtocolConfig &protocolConfig)
{
    beginResetModel();
...
void OpenVpnConfigModel::applyDefaultsToServerConfig(ВадькаVPN::OpenVpnServerConfig& config)
{
...
void OpenVpnConfigModel::applyDefaultsToClientConfig(ВадькаVPN::OpenVpnClientConfig& config)
{
...
ВадькаVPN::OpenVpnProtocolConfig OpenVpnConfigModel::getProtocolConfig()
{
