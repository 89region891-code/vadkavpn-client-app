...
struct XrayConfigSnapshot
{
    ...
    QDateTime createdAt;
    ВадькаVPN::XrayServerConfig serverConfig;
...
public slots:
    ...
    Q_INVOKABLE void createFromCurrent(const ВадькаVPN::XrayServerConfig &serverConfig);
    Q_INVOKABLE ВадькаVPN::XrayServerConfig applyConfig(int index) const;
...
private:
    ...
    void persistAll();
    void loadAll();
    static QString buildDisplayName(const ВадькаVPN::XrayServerConfig &cfg);
};
