...
QString errorString(ErrorCode code) {
    ...
    case(ErrorCode::ВадькаVPNServiceNotRunning): errorMessage = QObject::tr("Background service is not running"); break;
    ...
    case (ErrorCode::ВадькаVPNServiceConnectionFailed): errorMessage = QObject::tr("ВадькаVPN helper service error"); break;
    ...
    case (ErrorCode::LegacyApiV1NotSupportedError): errorMessage = QObject::tr("This legacy ВадькаVPN subscription format is no longer supported"); break;
    ...
    case (ErrorCode::ApiSubscriptionExpiredError): errorMessage = QObject::tr("Your ВадькаVPN Premium subscription has expired.\n Please check your email for renewal instructions.\n If you haven't received an email, please contact our support."); break;
