...
bool AppSplitTunnelingController::addApp(const ВадькаVPN::InstalledAppInfo &appInfo)
{
...
QVector<ВадькаVPN::InstalledAppInfo> AppSplitTunnelingController::getApps() const
{
    return m_apps;
}
