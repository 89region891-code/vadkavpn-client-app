...
if(NOT CLIENT_MACOS_NE_ENTITLEMENTS_FILE)
    set(CLIENT_MACOS_NE_ENTITLEMENTS_FILE "ВадькаVPNVPNNetworkExtension.entitlements" CACHE STRING "macOS network extension entitlements filename")
endif()
...
if(NOT CLIENT_MACOS_PROVISIONING_PROFILE_SPECIFIER)
    set(CLIENT_MACOS_PROVISIONING_PROFILE_SPECIFIER "distr macos.org.ВадькаVPN.ВадькаVPNVPN" CACHE STRING "macOS app provisioning profile specifier for release")
endif()
if(NOT CLIENT_MACOS_PROVISIONING_PROFILE_SPECIFIER_DEBUG)
    set(CLIENT_MACOS_PROVISIONING_PROFILE_SPECIFIER_DEBUG "dev macos.org.ВадькаVPN.ВадькаVPNVPN" CACHE STRING "macOS app provisioning profile specifier for debug")
endif()
if(NOT CLIENT_MACOS_NE_PROVISIONING_PROFILE_SPECIFIER)
    set(CLIENT_MACOS_NE_PROVISIONING_PROFILE_SPECIFIER "distr macos.org.ВадькаVPN.ВадькаVPNVPN.NE" CACHE STRING "macOS network extension provisioning profile specifier for release")
endif()
if(NOT CLIENT_MACOS_NE_PROVISIONING_PROFILE_SPECIFIER_DEBUG)
    set(CLIENT_MACOS_NE_PROVISIONING_PROFILE_SPECIFIER_DEBUG "dev macos.org.ВадькаVPN.ВадькаVPNVPN.NE" CACHE STRING "macOS network extension provisioning profile specifier for debug")
endif()
