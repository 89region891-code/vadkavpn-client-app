...
if(NOT CLIENT_IOS_NE_ENTITLEMENTS_FILE)
    set(CLIENT_IOS_NE_ENTITLEMENTS_FILE "ВадькаVPNVPNNetworkExtension.entitlements" CACHE STRING "iOS network extension entitlements filename")
endif()
if(NOT CLIENT_IOS_LAUNCHSCREEN_FILE)
    set(CLIENT_IOS_LAUNCHSCREEN_FILE "ВадькаVPNVPNLaunchScreen.storyboard" CACHE STRING "iOS launch screen storyboard filename")
endif()
...
if(NOT CLIENT_IOS_BUNDLE_ID)
    set(CLIENT_IOS_BUNDLE_ID "org.ВадькаVPN.ВадькаVPNVPN" CACHE STRING "iOS bundle id for App Store version lookup")
endif()
...
if(NOT CLIENT_IOS_PROVISIONING_PROFILE_SPECIFIER)
    set(CLIENT_IOS_PROVISIONING_PROFILE_SPECIFIER "distr ios.org.ВадькаVPN.ВадькаVPNVPN" CACHE STRING "iOS app provisioning profile specifier for release")
endif()
if(NOT CLIENT_IOS_PROVISIONING_PROFILE_SPECIFIER_DEBUG)
    set(CLIENT_IOS_PROVISIONING_PROFILE_SPECIFIER_DEBUG "dev ios.org.ВадькаVPN.ВадькаVPNVPN" CACHE STRING "iOS app provisioning profile specifier for debug")
endif()
if(NOT CLIENT_IOS_NE_PROVISIONING_PROFILE_SPECIFIER)
    set(CLIENT_IOS_NE_PROVISIONING_PROFILE_SPECIFIER "distr ios.org.ВадькаVPN.ВадькаVPNVPN" CACHE STRING "iOS network extension provisioning profile specifier for release")
endif()
if(NOT CLIENT_IOS_NE_PROVISIONING_PROFILE_SPECIFIER_DEBUG)
    set(CLIENT_IOS_NE_PROVISIONING_PROFILE_SPECIFIER_DEBUG "dev ios.org.ВадькаVPN.ВадькаVPNVPN" CACHE STRING "iOS network extension provisioning profile specifier for debug")
endif()
