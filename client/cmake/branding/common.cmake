if(NOT CLIENT_TARGET_NAME)
    set(CLIENT_TARGET_NAME "ВадькаVPNVPN" CACHE STRING "Client executable target name")
endif()
if(NOT CLIENT_APPLICATION_NAME)
    set(CLIENT_APPLICATION_NAME "ВадькаVPNVPN" CACHE STRING "Application display and executable name")
endif()
if(NOT CLIENT_SERVICE_NAME)
    set(CLIENT_SERVICE_NAME "ВадькаVPNVPN-service" CACHE STRING "Service executable name")
endif()
if(NOT CLIENT_ORGANIZATION_NAME)
    set(CLIENT_ORGANIZATION_NAME "ВадькаVPNVPN.ORG" CACHE STRING "QSettings organization name")
endif()
if(NOT CLIENT_APP_INSTANCE_NAME)
    set(CLIENT_APP_INSTANCE_NAME "ВадькаVPNVPNInstance" CACHE STRING "Single-instance local server name")
endif()
...
if(NOT CLIENT_TS_PREFIX)
    set(CLIENT_TS_PREFIX "ВадькаVPNvpn" CACHE STRING "Translation filename prefix")
endif()
