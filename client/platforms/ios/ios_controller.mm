...
bool isWireGuardBasedProto(ВадькаVPN::Proto proto) {
    return proto == ВадькаVPN::Proto::WireGuard || proto == ВадькаVPN::Proto::Awg;
}
...
bool IosController::connectVpn(ВадькаVPN::Proto proto, const QJsonObject& configuration)
{
    m_proto = proto;
    ...
    if (proto == ВадькаVPN::Proto::OpenVpn) {
        return setupOpenVPN();
    }
    if (proto == ВадькаVPN::Proto::WireGuard) {
        return setupWireGuard();
    }
    if (proto == ВадькаVPN::Proto::Awg) {
        return setupAwg();
    }
    if (proto == ВадькаVPN::Proto::Xray) {
        return setupXray();
    }
    if (proto == ВадькаVPN::Proto::SSXray) {
        return setupSSXray();
    }
...
{
    QJsonObject ovpn = m_rawConfig[ProtocolUtils::key_proto_config_data(ВадькаVPN::Proto::OpenVpn)].toObject();
...
{
    QJsonObject config = m_rawConfig[ProtocolUtils::key_proto_config_data(ВадькаVPN::Proto::WireGuard)].toObject();
...
{
    QJsonObject config = m_rawConfig[ProtocolUtils::key_proto_config_data(ВадькаVPN::Proto::Xray)].toObject();
...
{
    QJsonObject config = m_rawConfig[ProtocolUtils::key_proto_config_data(ВадькаVPN::Proto::SSXray)].toObject();
...
{
    QJsonObject config = m_rawConfig[ProtocolUtils::key_proto_config_data(ВадькаVPN::Proto::Awg)].toObject();
