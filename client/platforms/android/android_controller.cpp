...
namespace
{
    ...
    constexpr auto QT_ANDROID_CONTROLLER_CLASS = "org/ВадькаVPN/vpn/qt/QtAndroidController";
    constexpr auto ANDROID_LOG_CLASS = "org/ВадькаVPN/vpn/util/Log";
    constexpr auto TAG = "ВадькаVPNQt";
} // namespace
